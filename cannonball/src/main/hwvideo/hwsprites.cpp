...
void hwsprites::init(const uint32_t* src_sprites)
{
    reset();
    sprites = src_sprites; // already decoded by tools/mkoutrundata
#else
...
void OUTRUN_HOT(hwsprites::render)(const uint8_t priority)
{
