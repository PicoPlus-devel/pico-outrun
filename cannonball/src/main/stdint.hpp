...
/* picoOutRun: Boost was used here only for the compile-time size assertions
 * below, which C++11's static_assert does natively. Upstream's own comment
 * invites this ("If you're sure the sizes are correct, it can be removed for
 * your port"), and it removes the Boost dependency from the entire port. */
